...
export default function CheckboxSelect(props) {
  ...
  function uploadOptionsSelectForBackend () {
    ...
    const existingOptionIndex = categorieWithOptionSelectedForString.findIndex(
    ...
    if (existingOptionIndex !== -1) {
      ...
      const updatedoptionSelectedForOneCategorieForBackend = [...categorieWithOptionSelectedForString];
    ...
    store.dispatch( setCategorieWithOptionSelectedForString(updatedoptionSelectedForOneCategorieForBackend));
    } 
