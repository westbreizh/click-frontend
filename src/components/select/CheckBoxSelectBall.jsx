...
export default function CheckboxSelect(props) {
  ...
  function uploadOptionsSelectForBackend () {
    ...
    const existingOptionIndex = categorieWithOptionSelectedForBall.findIndex(
    ...
    if (existingOptionIndex !== -1) {
      ...
      const updatedoptionSelectedForOneCategorieForBackend = [...categorieWithOptionSelectedForBall];
    ...
    store.dispatch( setCategorieWithOptionSelectedForBall(updatedoptionSelectedForOneCategorieForBackend));
    } 
