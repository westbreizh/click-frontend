...
var _ModalValidationAddToCartInstallation = _interopRequireDefault(require("../../components/modal/modalValidation/ModalValidationAddToCartInstallation"));
...
function Stringing() {
  var stringingPriceWithStringFromAnotherWhere = 10; //prix de la pose  avec cordage acheté ailleurs

  var stringFromShop = (0, _reactRedux.useSelector)(function (state) {
    return state.cart.stringFromShopChoice;
  }); // dans le slice redux on initialise la preference joueur si il y a 
  ...
  var _useState7 = (0, _react.useState)(userInfo.hubBackInfo),
    _useState8 = _slicedToArray(_useState7, 2),
    hubBackChoice = _useState8[0],
    setHubBackChoice = _useState8[1];
  var _useState9 = (0, _react.useState)(userInfo.racquet_player),
    _useState10 = _slicedToArray(_useState9, 2),
    racquetPlayer = _useState10[0],
    setRacquetPlayer = _useState10[1];
  var _useState11 = (0, _react.useState)(userInfo.stringFromPlayerOrigin),
    _useState12 = _slicedToArray(_useState11, 2),
    stringFromPlayerOrigin = _useState12[0],
    setStringFromPlayerOrigin = _useState12[1];
  var _useState13 = (0, _react.useState)(userInfo.numberKnotChoice),
    _useState14 = _slicedToArray(_useState13, 2),
    numberKnotChoice = _useState14[0],
    setnumberKnotChoice = _useState14[1];
  var _useState15 = (0, _react.useState)(false),
    _useState16 = _slicedToArray(_useState15, 2),
    isSubmenuValidationOpen = _useState16[0],
    setSubmenuValidation = _useState16[1];
  var _useState17 = (0, _react.useState)(false),
    _useState18 = _slicedToArray(_useState17, 2),
    isCheckBoxChecked = _useState18[0],
    setCheckBoxChecked = _useState18[1];
  var _useState19 = (0, _react.useState)(false),
    _useState20 = _slicedToArray(_useState19, 2),
    stringFromPlayerSelected = _useState20[0],
    setStringFromPlayerSelected = _useState20[1];
  ...
  var _useState21 = (0, _react.useState)(""),
    ...
    dateRacquetReady = _useState22[0],
    setDateRacquetReady = _useState22[1];
  var _useState23 = (0, _react.useState)(new Date()),
    _useState24 = _slicedToArray(_useState23, 2),
    dateOrigin = _useState24[0],
    setDateOrigin = _useState24[1];
  (0, _react.useEffect)(function () {
    ...
    var dateRacquetOK = (0, _dateFns.addDays)(dateOrigin, 1);
  ...
  var isValid = (hubChoice !== null && hubChoice !== void 0 ? hubChoice : null) !== null && (hubBackChoice !== null && hubBackChoice !== void 0 ? hubBackChoice : null) !== null && (stringRopeChoice !== null && stringRopeChoice !== void 0 ? stringRopeChoice : null) !== null && racquetPlayer !== "" && racquetPlayer !== null && racquetPlayer !== undefined && (stringFromPlayer !== "" && stringFromPlayer !== undefined && stringFromPlayer !== null && stringFromPlayerOrigin !== null || (stringFromShop !== null && stringFromShop !== void 0 ? stringFromShop : null) !== null);
          ...
          case 6:
            ...
            if (stringFromPlayer !== null && stringFromShop === null) {
              ...
              article = _objectSpread(_objectSpread({}, article), {}, {
                stringRopeChoice: stringRopeChoice,
                numberKnotChoice: numberKnotChoice,
                stringFromPlayer: stringFromPlayer,
                racquetPlayer: racquetPlayer,
                hubChoice: hubChoice,
                hubBackChoice: hubBackChoice,
                dateRacquetReady: dateRacquetReady
              });
            ...
            dispatch((0, _cartSlice.addInstallationString)(article));
  ...
  return /*#__PURE__*/React.createElement("main", {
    ...
    className: "stringing__contenair"
  }, /*#__PURE__*/React.createElement("div", {
    className: "stringing-header__wrapper"
  }, /*#__PURE__*/React.createElement("h1", {
    className: "stringing-header__title"
  }, "Commandez votre cordage!")), /*#__PURE__*/React.createElement("div", {
    ...
    className: "  stringing-form__section-wrapper section-wrapper-date"
  }, /*#__PURE__*/React.createElement("label", {
    className: "stringing-form__label"
  }, " Date du retour "), /*#__PURE__*/React.createElement("div", {
    className: "stringing-form__own-string-wrapper stringing-form__date-wrapper  "
  }, /*#__PURE__*/React.createElement("div", {
    className: "validation-bubble-checked     "
  }, /*#__PURE__*/React.createElement("span", null, "\u2713")), /*#__PURE__*/React.createElement("div", {
    className: "stringing-form__text-h2"
  }, "A partir du ", dateRacquetReady))), /*#__PURE__*/React.createElement("div", {
    className: " stringing-form__section-wrapper section-wrapper-button"
  }, isConnected === true ? /*#__PURE__*/React.createElement("div", {
    className: "stringing-form__wrapper-input-checkbox"
  }, /*#__PURE__*/React.createElement("input", {
    type: "checkbox",
    className: "order-stringer-detail__checkbox",
    onClick: function onClick() {
      return setCheckBoxChecked(!isCheckBoxChecked);
    }
  }), /*#__PURE__*/React.createElement("div", {
    className: "order-stringer-detail__checkbox-text"
  }, "Sauvegarder mes choix")) : null, /*#__PURE__*/React.createElement("button", {
    onClick: function onClick() {
      return onSubmit();
    },
    disabled: !isValid,
    type: "submit",
    className: "stringing-form__btn-order btn btn-blue ".concat(isValid ? "" : "btn-blue-invalid")
  }, "Push cordage in the popoche"), isSubmenuValidationOpen && /*#__PURE__*/React.createElement(_ModalValidationAddToCartInstallation.default, {
