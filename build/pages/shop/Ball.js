...
var _CheckBoxSelectBall = _interopRequireDefault(require("../../components/select/CheckBoxSelectBall"));
...
function Ball() {
  ...
  var categorieWithOptionSelectedForBall = (0, _reactRedux.useSelector)(function (state) {
    return state.product.categorieWithOptionSelectedForBall;
  });
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return fetch("https://click-backend.herokuapp.com/api/shop/ballListFiltered", {
              mode: "cors",
              method: "POST",
              body: JSON.stringify({
                productCategorie: "ball",
                categorieWithOptionSelectedForBall: categorieWithOptionSelectedForBall
              }),
              headers: {
                "Content-Type": "application/json"
              }
  ...
  (0, _react.useEffect)(function () {
    store.dispatch((0, _productSlice.setCategorieWithOptionSelectedForBall)([]));
  }, []);
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_NavbarShop.default, null), /*#__PURE__*/React.createElement("main", {
  ...
  }, " Balles "), /*#__PURE__*/React.createElement("div", {
    className: "checkboxSelects__wrapper"
  }, _localDataBase.datasForSelectsBall.map(function (object, index) {
    return /*#__PURE__*/React.createElement(_CheckBoxSelectBall.default, {
  ...
  }, categorieWithOptionSelectedForBall.map(function (object, index) {
    ...
    return /*#__PURE__*/React.createElement(_reactRouterDom.NavLink, {
      key: index,
      to: "/fiche_produit/balle/".concat(product.id),
    ...
    }, product.packaging), /*#__PURE__*/React.createElement("div", {
  ...
  }, "Il n'y a aucune balles correspondant aux options choisies !") : /*#__PURE__*/React.createElement("div", {
