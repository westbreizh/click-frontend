...
function SelectHub(props) {
  var setHubChoice = props.setHubChoice;
  var _useState = (0, _react.useState)([]),
    _useState2 = _slicedToArray(_useState, 2),
    datasForSelectHub = _useState2[0],
    setDatasForSelectHub = _useState2[1];
  var _useState3 = (0, _react.useState)(false),
    _useState4 = _slicedToArray(_useState3, 2),
    isOpen = _useState4[0],
    setIsOpen = _useState4[1];
  var handleChange = function handleChange(value) {
    var hubSelected = value;
  ...
  var fetchHubCollectList = /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return fetch('https://click-backend.herokuapp.com/api/shop/listHubCollect', {
              method: 'POST',
              mode: 'cors',
              headers: {
    ...
    return function fetchHubCollectList(_x) {
  ...
  }, "choisissez le lieu de d\xE9pot"), /*#__PURE__*/React.createElement("span", {
  ...
  }, datasForSelectHub.map(function (option) {
