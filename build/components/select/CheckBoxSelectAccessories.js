...
function CheckboxSelect(props) {
  ...
  function uploadOptionsSelectForBackend() {
    ...
    var existingOptionIndex = categorieWithOptionSelectedForAccessories.findIndex(function (option) {
    ...
    if (existingOptionIndex !== -1) {
      ...
      var updatedoptionSelectedForOneCategorieForBackend = _toConsumableArray(categorieWithOptionSelectedForAccessories);
      ...
      store.dispatch((0, _productSlice.setCategorieWithOptionSelectedForAccessories)(updatedoptionSelectedForOneCategorieForBackend));
    }

    // on ajoute une nouelle categorie avec ses options
    else {
      store.dispatch((0, _productSlice.setCategorieWithOptionSelectedForAccessories)([].concat(_toConsumableArray(categorieWithOptionSelectedForAccessories), [{
        fieldNameBdd: fieldNameBdd,
        optionSelectedForOneCategorie: optionSelectedForOneCategorie
      }])));
    }
