...
function CheckboxSelect(props) {
  ...
  function uploadOptionsSelectForBackend() {
    ...
    var existingOptionIndex = categorieWithOptionSelectedForBall.findIndex(function (option) {
    ...
    if (existingOptionIndex !== -1) {
      ...
      var updatedoptionSelectedForOneCategorieForBackend = _toConsumableArray(categorieWithOptionSelectedForBall);
      ...
      store.dispatch((0, _productSlice.setCategorieWithOptionSelectedForBall)(updatedoptionSelectedForOneCategorieForBackend));
    }

    // on ajoute une nouelle categorie avec ses options
    else {
      store.dispatch((0, _productSlice.setCategorieWithOptionSelectedForBall)([].concat(_toConsumableArray(categorieWithOptionSelectedForBall), [{
        fieldNameBdd: fieldNameBdd,
        optionSelectedForOneCategorie: optionSelectedForOneCategorie
      }])));
    }
