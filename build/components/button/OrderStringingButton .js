...
exports.default = OrderStringingButton;
...
function OrderStringingButton(props) {
  var stringingWithString = props.stringingWithString;
  ...
  var handleAddToCart = function handleAddToCart() {
    dispatch((0, _cartSlice.addArticle)(stringingWithString));
  ...
  }, "Ajout\xE9 au panier"), isSubmenuValidationOpen && /*#__PURE__*/React.createElement(_ModalValidationAddToCart.default, {
