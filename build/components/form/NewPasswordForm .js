...
function NewPasswordForm(props) {
  ...
  var paramsUrl = (0, _reactRouterDom.useParams)();
  var userId = paramsUrl.id.split('=')[1];
  var token = paramsUrl.token.split('=')[1];
  ...
  var _useForm = (0, _reactHookForm.useForm)({
      resolver: (0, _yup.yupResolver)(_shemaInput.shemaInputResetPassword),
      mode: 'onTouched',
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return fetch("https://click-backend.herokuapp.com/api/user/saveResetPassword", {
              mode: "cors",
              method: "POST",
              body: JSON.stringify({
  ...
  return /*#__PURE__*/React.createElement("form", {
  ...
  }, "Nouveau mot de passe ", /*#__PURE__*/React.createElement("sup", null, "*"), " "), /*#__PURE__*/React.createElement(CustomInput, _extends({
    ...
    className: "input__label"
  }, " Confirmation du mot de passe ", /*#__PURE__*/React.createElement("sup", null, "*"), " "), /*#__PURE__*/React.createElement(CustomInput, _extends({
  ...
  }, "Modifier"), /*#__PURE__*/React.createElement(_reactRouterDom.Link, {
    to: "/",
